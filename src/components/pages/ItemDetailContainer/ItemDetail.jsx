  ...
  return (
    <div className="flex justify-center items-center mt-10">
      <div className="border-inherit border-2 rounded-2xl p-6 w-auto">
        ...
        <div className="">
          {initial && <h5 className="mt-4 text-indigo-500	font-bold	">Ya tienes {initial} unidades en el carrito</h5>}
          ...
          {
            showCounter ?   <div><CounterContainer
            stock={product.stock}
            onAdd={onAdd}
            initial={initial}
          /></div> :  <Link to="/cart" className="flex items-center justify-center">
